<?php
/**
 * Autoload file for the Codevirtus Payments package.
 *
 * This file registers an autoloader that automatically includes class files
 * based on the class names, following PSR-4 standards.
 */
